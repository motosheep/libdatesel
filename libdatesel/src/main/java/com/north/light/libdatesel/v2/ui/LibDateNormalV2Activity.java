 ...
 * v2日期选择
 */
public class LibDateNormalV2Activity extends LibDateBaseActivity {

    public static final String CODE_REQUEST = "CODE_REQUEST";
    //1年月日时分秒，2年月日时分 3年月日时，4年月日，5时分秒，6时分，7年月，8年
    private int mType = 1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lib_date_normal_v2);
        try {
            initView();
            initEvent();
        } catch (Exception e) {
            Toast.makeText(LibDateNormalV2Activity.this, "日期控件错误:" + e.getMessage(), Toast.LENGTH_SHORT).show();
            finish();
        }
    }
    ...
    private void initEvent() throws Exception {
        ...
        mConfirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DateMainV2.getInstance().onSelData(selResult);
                finish();
            }
        });
    ...
    private void initView() throws Exception {
        ...
        //控件初始化
        mYearPicker = findViewById(R.id.activity_lib_sel_date_v2_content_year);
        mMonthPicker = findViewById(R.id.activity_lib_sel_date_v2_content_month);
        mDayPicker = findViewById(R.id.activity_lib_sel_date_v2_content_day);
        mHourPicker = findViewById(R.id.activity_lib_sel_date_v2_content_hour);
        mMinutePicker = findViewById(R.id.activity_lib_sel_date_v2_content_minute);
        mSecondPicker = findViewById(R.id.activity_lib_sel_date_v2_content_second);
        mCancel = findViewById(R.id.activity_lib_sel_date_v2_cancel);
        mConfirm = findViewById(R.id.activity_lib_sel_date_v2_confirm);
